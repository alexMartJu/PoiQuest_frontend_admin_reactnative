...
import { useCityDetailQuery } from '@/hooks/queries/partners';
import { CityForm } from '@/components/partners';
...
export default function CityEditScreen() {
  ...
  return (
    <View style={themed.container}>
      ...
      <CityForm city={city} onSuccess={() => router.back()} onCancel={() => router.back()} />
    </View>
  );
}
